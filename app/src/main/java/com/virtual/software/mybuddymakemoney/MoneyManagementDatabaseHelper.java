...
public class MoneyManagementDatabaseHelper extends SQLiteOpenHelper {

    // Database Name
    private static final String DATABASE_NAME = "moneymanagement_db";

    // Table Name
    private static final String TABLE_NAME = "money_management_table";
    ...
    public MoneyManagementDatabaseHelper(Context context) {
    ...
    public boolean save(MoneyManagementModel model) {
        ...
        values.put(COL_IS_SELECTED, model.isSelected() ? 1 : 0);
    ...
    public List<MoneyManagementModel> getAllSortedByName() {
        List<MoneyManagementModel> models = new ArrayList<>();
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                do {
                    MoneyManagementModel model = new MoneyManagementModel();
    ...
    public MoneyManagementModel getSelectedItem() {
